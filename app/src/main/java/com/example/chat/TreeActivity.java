...
public class TreeActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    Handler h1 = new Handler()
    {
        public void handleMessage(Message msg)
        {
            ...
            {
                Log.i("MySql11:", "4" );
                TreeAdapter treeAdapter = new TreeAdapter(TreeActivity.this, root);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        {
            // myTag
            Intent intent=new Intent(TreeActivity.this,ChatMainActivity.class);
            Bundle bd=new Bundle(  );
            ...
            if(msg.what==1)
            {
                ...
                if(0!=AddFriendList.size())
                {
                    for(int i = 0; i <AddFriendList.size();i++) {
                        ...
                        AlertDialog ad = new AlertDialog.Builder(TreeActivity.this).create();
